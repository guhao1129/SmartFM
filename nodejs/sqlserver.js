...
const conf = require("./config.js").db2;
...
var add = async function (addObj, tableName, callBack) {        console.log("add了")
...
var update = async function (updateObj, whereObj, where, tableName, callBack) {
    try {
        var ps = new mssql.PreparedStatement(con);
